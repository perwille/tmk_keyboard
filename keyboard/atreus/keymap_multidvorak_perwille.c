...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, \
         ...
         KC_ESC, KC_TAB, KC_LGUI, KC_LSFT, KC_SPC, KC_FN11, KC_FN12,     \
         // KC_MINS and KC_LBRC are inverse-dvorakized
         KC_ENT, KC_FN0, KC_QUOT, KC_FN13, KC_ENT),                     \
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2), KC_UP, SHIFT(KC_MINS), SHIFT(KC_EQUAL), \
         ...
         KC_FN1, SHIFT(KC_INS), KC_LGUI, KC_LSFT, KC_SPC, KC_FN11, KC_FN12, \
           KC_ENT, KC_FN0, KC_E, KC_0, KC_RBRC), \
  ...
  KEYMAP(KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, KC_F, KC_G, KC_C, KC_R, KC_L, \
         ...
         KC_ESC, KC_TAB, KC_LGUI, KC_LSFT, KC_SPC, KC_FN11, KC_FN12,     \
         KC_ENT, KC_FN6, KC_QUOT, KC_SLSH, KC_ENT),                     \
  ...
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2), KC_UP, SHIFT(KC_MINS), SHIFT(KC_EQUAL), \
         ...
         KC_MINS, KC_EQUAL, SHIFT(KC_9), SHIFT(KC_0), SHIFT(KC_7),      \
           KC_GRAVE, KC_1, KC_2, KC_3, KC_BSLS,                       \
         KC_FN7, SHIFT(KC_INS), KC_LGUI, KC_LSFT, KC_SPC, KC_FN11, KC_FN12, \
  ...
  KEYMAP(KC_INS, KC_HOME, KC_UP, KC_END, KC_PGUP, KC_UP, KC_F7, KC_F8, KC_F9, KC_F10, \
         ...
         KC_NO, KC_NO, KC_LGUI, KC_LSFT, KC_SPC, KC_FN11, KC_FN12, KC_ENT, KC_FN8, KC_NO, KC_NO, KC_FN10)
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [12] = ACTION_MODS_TAP_KEY(MOD_LALT, KC_TAB),
  [13] = ACTION_MODS_TAP_KEY(MOD_RALT, KC_LBRC),
  [14] = ACTION_MODS_TAP_KEY(MOD_RALT, KC_SLSH)
};
